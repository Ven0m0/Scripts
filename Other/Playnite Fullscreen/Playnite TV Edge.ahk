...
RunWait, %A_ScriptDir%\MultiMonitorTool\MultiMonitorTool.exe /MoveWindow 1 Process "msedge.exe"
...
Playnite(){
    if !WinExist("ahk_exe Playnite.FullscreenApp.exe") {
        ...
        RunWait, %A_ScriptDir%\MultiMonitorTool\MultiMonitorTool.exe /MoveWindow 2 Process "msedge.exe"
        ExitApp
    }
}