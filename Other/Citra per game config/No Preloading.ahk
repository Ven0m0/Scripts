...
TF_RegExReplace("!C:\Users\janni\OneDrive\Backup\Game\Emul\Citra\canary-mingw\user\config\qt-config.ini","resolution_factor=([2-9]|10|1)","resolution_factor=10")

; Texture Filter to XBRZ Freescale
TF_Replace("!C:\Users\janni\OneDrive\Backup\Game\Emul\Citra\canary-mingw\user\config\qt-config.ini","texture_filter_name=none","texture_filter_name=xBRZ freescale")
TF_Replace("!C:\Users\janni\OneDrive\Backup\Game\Emul\Citra\canary-mingw\user\config\qt-config.ini","texture_filter_name\default=true","texture_filter_name\default=false")
