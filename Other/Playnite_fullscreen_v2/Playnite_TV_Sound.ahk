...
;
; WARNING: Contains hardcoded paths and device names that need customization
;   - Line 34: User-specific path (janni)
;   - Lines 26, 66: Audio device names specific to this system
;   - Update before use
; ============================================================================
...
; TODO: Update audio device name to match your system
RunWait(A_ScriptDir . "\SoundVolumeView\SoundVolumeView.exe /SetDefault `"NVIDIA High Definition Audio`"", , "hide")
...
CheckPlaynite() {
    if (!WinExist("ahk_exe Playnite.FullscreenApp.exe")) {
        ...
        ; Restore audio output to default device
        ; TODO: Update audio device name to match your system
        RunWait(A_ScriptDir . "\SoundVolumeView\SoundVolumeView.exe /SetDefault `"THX Spatial - Synapse`"", , "hide")
